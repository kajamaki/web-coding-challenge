...
class User extends EloquentUser implements RoleableInterface, PermissibleInterface, PersistableInterface, UserInterface, Authenticatable
{
    use PermissibleTrait, HasApiTokens;
